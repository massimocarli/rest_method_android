...
import uk.co.massimocarli.restmethod.http.RestExecutor;
 ...
 */
public class GetRestTest extends JettyServerAndroidTestCaseForGet {

    /**
     * The Tag for the Log
     */
    private static final String TAG_LOG = GetRestTest.class.getName();
