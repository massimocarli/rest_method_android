 ...
 */
public class HttpClientGETCommandTest extends JettyServerAndroidTestCaseForGet {

    /**
     * The Tag for the Log
     */
    private static final String TAG_LOG = HttpClientGETCommandTest.class.getName();
    ...
    public void testSuccessGet() {
        ...
        try {
            RestCommandResult<String> result = HttpClientRestCommandExecutor.create().execute(getContext(), getCommand,
